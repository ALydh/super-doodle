...
case class WargearWithQuantity(
  wargear: wp40k.domain.models.Wargear,
  quantity: Int,
  modelType: Option[String]
)

case class BattleUnitData(
  unit: wp40k.domain.army.ArmyUnit,
  datasheet: wp40k.domain.models.Datasheet,
  profiles: List[wp40k.domain.models.ModelProfile],
  wargear: List[WargearWithQuantity],
  abilities: List[wp40k.domain.models.DatasheetAbility],
  keywords: List[wp40k.domain.models.DatasheetKeyword],
  cost: Option[wp40k.domain.models.UnitCost],
  enhancement: Option[wp40k.domain.models.Enhancement]
)

case class FilterWargearRequest(
  selections: List[wp40k.domain.army.WargearSelection],
  unitSize: Int,
  sizeOptionLine: Int
)
...
case class AlliedFactionInfo(
  ...
  factionName: String,
  allyType: String,
  datasheets: List[wp40k.domain.models.Datasheet]
)
