...
export const SM_CHAPTERS: Chapter[] = [
  ...
  { id: "black-templars", name: "Black Templars", keyword: "Black Templars", themeKey: "sm-black-templars" },
  { id: "deathwatch", name: "Deathwatch", keyword: "Deathwatch", themeKey: "sm-deathwatch" },
...
export const CHAPTER_DETACHMENTS: Record<string, string[]> = {
  ...
  "dark-angels": ["000000834", "000000835", "000000836", "000000981", "000001059"],
  "space-wolves": ["000001008", "000001068", "000001069", "000001070", "000001126"],
  "black-templars": ["000001006", "000001091", "000001092", "000001093"],
  "deathwatch": ["000000808"],
  "imperial-fists": ["000001103"],
  "iron-hands": ["000001118"],
  "salamanders": ["000001086"],
